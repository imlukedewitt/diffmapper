...
function updateSidebarTabCounts() {
  ...
  const questionCount = document.querySelectorAll('.annotation-item.question:not(.resolved), .annotation-item.concern:not(.resolved)').length;
